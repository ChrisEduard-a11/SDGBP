                    ...
                    <tr>
                        <td style='padding: 40px 40px 30px 40px;'>
                            ...
                            <div style='text-align: center;'>
                                <a href='https://sdgbp.wuaze.com/vistas/login.php' style='display: inline-block; padding: 14px 28px; background-color: #10b981; color: #ffffff; text-decoration: none; font-size: 16px; font-weight: bold; border-radius: 8px;'>Ir al Acceso del Sistema</a>
                            </div>
                        </td>
                    </tr>
                    <!-- Footer -->
