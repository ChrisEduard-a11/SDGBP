...
<div id="layoutSidenav_content">
    <div class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between align-items-center mt-4 mb-3">
            <div>
                <h2 class="fw-800 text-dark mb-0">Balance Financiero Global</h2>
                <p class="text-muted small">Historial detallado de transacciones y estados de cuenta</p>
            </div>
            <div class="breadcrumb mb-0 glass-card px-3 py-2 shadow-sm d-none d-md-flex">
                <a href="javascript:void(0);" onclick="navigateTo('inicio.php')" class="text-decoration-none small text-primary"><i class="fas fa-home"></i> Inicio</a>
                <span class="mx-2 text-muted">/</span>
                <span class="small text-muted">Pagos Registrados</span>
            </div>
        </div>
