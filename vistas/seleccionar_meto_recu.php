...
<head>
    ...
    <title>Seleccionar Método de Recuperación - SDGBP</title>
    ...
    <style>
        ...
        .inst-select { width: 100%; background: transparent; border: none; padding: 1.1rem 0; color: #1e293b; font-size: 1rem; outline: none; font-weight: 500; cursor: pointer; appearance: none; }
            ...
            <div class="login-image-content">
                ...
                <div class="flex items-center gap-4 mt-8">
                    <div class="flex -space-x-3">
                        ...
                        <div class="w-10 h-10 rounded-full bg-slate-800 border-2 border-slate-700 flex items-center justify-center"><i class="fas fa-question-circle text-slate-300 text-sm"></i></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="login-form-container">
                ...
                <div class="stepper">
                    ...
                    <div class="step-item active">
                        <div class="step-circle">2</div><div class="step-label">Método</div>
                    </div>
                    <div class="step-item">
                ...
                <div class="text-center md:text-left mb-6">
                    <h4 class="font-bold text-lg text-slate-800">Paso 2: Elegir Método</h4>
                    <p class="text-slate-500 text-sm font-medium mt-1">Selecciona cómo deseas verificar tu identidad.</p>
                </div>

                <form action="../acciones/procesar_seleccion_recu.php" method="POST" onsubmit="return validateFormMC()" class="mt-4">
                    <div class="recovery-icon mx-auto md:mx-0"><i class="fas fa-cogs"></i></div>

                    <div>
                        <label class="inst-label text-center md:text-left" for="metodo">Método de Recuperación (*)</label>
                        <div class="inst-input-wrapper pr-2">
                            <i class="fas fa-tasks inst-icon"></i>
                ...
                <div class="inst-links">
                    <a href="recuperar.php" class="inst-link"><i class="fas fa-arrow-left"></i> Volver al Inicio</a>
                </div>
            </div>
