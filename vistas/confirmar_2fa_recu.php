    ...
    <div class="login-layout">
        <div class="login-image-side">
            ...
            <div class="login-image-content">
                ...
                <p class="login-image-desc">Validaremos el código de 6 dígitos que fue enviado de manera cifrada a tu bandeja de correo personal para verificar tu autorización corporativa.</p>
