...
<head>
    ...
    <style>
        ...
        .stepper::before {
            content: ''; position: absolute; top: 15px; left: 15%; right: 15%; height: 2px;
        ...
        .step-circle {
            ...
            margin: 0 auto 8px; font-weight: bold; color: #64748b; transition: all 0.3s ease;
        }
        .step-item.active .step-circle {
            background: #f18000; border-color: #f18000; color: #fff; box-shadow: 0 0 0 4px rgba(241, 128, 0, 0.2);
        }
        .step-label {
            font-size: 10px; font-weight: bold; color: #64748b; text-transform: uppercase; letter-spacing: 0.5px;
        }
    ...
    <div class="login-layout">
        ...
        <div class="login-image-side">
            ...
            <div class="login-image-content">
                ...
                <h1 class="login-image-title">Recupera tu<br><span>Acceso</span></h1>
                <p class="login-image-desc">
                    Si perdiste acceso a tu cuenta, sigue nuestros pasos de verificación estructurada. Protege tu identidad y vuelve a la plataforma rápidamente.
                </p>
                <div class="flex items-center gap-4 mt-8">
                    <div class="flex -space-x-3">
                        <div class="w-10 h-10 rounded-full bg-slate-800 border-2 border-slate-700 flex items-center justify-center"><i class="fas fa-sync text-slate-300 text-sm"></i></div>
                    ...
                    <span class="text-sm font-medium text-slate-300">Recuperación Segura</span>
                </div>
            </div>
        </div>
            ...
            <div class="login-form-container">
                ...
                <form name="recuperarForm" action="../acciones/recuperar_clave.php" method="POST" onsubmit="return validateFormRCU()" class="mt-4">
                    ...
                    <button class="inst-btn-submit mt-4" type="submit">
                        <i class="fas fa-check-circle"></i> Validar Usuario
                    </button>

                    <div class="mt-4 text-center">
                        <a href="recuperar_usuario.php" class="text-sm text-primary hover:text-primary-dark font-bold transition-colors">¿Olvidaste tu nombre de usuario?</a>
                    </div>
                </form>
