            ...
            <div class="login-form-container">
                ...
                <form name="preguntaForm" action="../acciones/validar_res.php" method="POST" onsubmit="return validateFormPS()" class="mt-4">
                    ...
                    <div class="inst-input-wrapper">
                        ...
                        <div class="inst-input-inner relative">
                            ...
                            <button type="button" class="absolute right-0 top-1/2 -translate-y-1/2 text-slate-400 hover:text-primary transition-colors p-2" onclick="togglePasswordVisibility('inputRespuesta', this)">
                    ...
                    <div class="inst-input-wrapper">
                        ...
                        <div class="inst-input-inner relative">
                            ...
                            <button type="button" class="absolute right-0 top-1/2 -translate-y-1/2 text-slate-400 hover:text-primary transition-colors p-2" onclick="togglePasswordVisibility('inputRespuesta2', this)">
                                <i class="fas fa-eye"></i>
                            </button>
                        </div>
                    </div>
