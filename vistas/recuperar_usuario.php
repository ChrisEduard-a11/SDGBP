...
<head>
    ...
    <style>
        ...
        @media (min-width: 1280px) { .login-form-side { width: 550px; } }
    ...
    <div class="login-layout">
        <div class="login-image-side">
            ...
            <div class="login-image-content">
                <div class="login-badge">Asistencia de Acceso</div>
                <h1 class="login-image-title">Encuentra tu<br>Usuario <span>Perdido</span></h1>
                <p class="login-image-desc">Validaremos tu identidad personal frente al sistema para ubicar tu cuenta y restaurar rápidamente tu acceso a la plataforma corporativa.</p>
                <div class="flex items-center gap-4 mt-8">
                    <div class="flex -space-x-3">
                        <div class="w-10 h-10 rounded-full bg-slate-800 border-2 border-slate-700 flex items-center justify-center"><i class="fas fa-id-card text-slate-300 text-sm"></i></div>
                    ...
                    <span class="text-sm font-medium text-slate-300">Búsqueda Confiable</span>
                </div>
            </div>
        </div>
        ...
        <div class="login-form-side">
            <div class="login-form-container">
                <div class="text-center md:text-left mb-6">
                    ...
                    <h2 class="inst-title">Recuperar Usuario</h2>
                </div>

                <div class="stepper">
                    <div class="step-item active">
                        <div class="step-circle">1</div><div class="step-label">ID</div>
                    </div>
                    <div class="step-item">
                ...
                <div class="text-center md:text-left mb-6">
                    ...
                    <p class="text-slate-500 text-sm font-medium mt-1">Valida tu Cédula de Identidad en el sistema.</p>
                </div>

                <form action="../acciones/validar_ci_recu_usuario.php" method="POST" onsubmit="return validateFormRecuU()" class="mt-4">
                    <div class="recovery-icon mx-auto md:mx-0"><i class="fas fa-id-card"></i></div>

                    <div>
                        <label class="inst-label text-center md:text-left" for="inputCI">Cédula de Identidad (*)</label>
                        <div class="inst-input-wrapper">
                            <i class="fas fa-id-badge inst-icon"></i>
                            <input id="inputCI" type="text" name="cedula" class="inst-input" style="text-align: center; font-size: 1.1rem; letter-spacing: 1px;" placeholder="Tu número de cédula" autocomplete="off" oninput="this.value = this.value.replace(/[^0-9]/g, '');" />
                        </div>
                    </div>
                ...
                <div class="inst-links">
                    <a href="recuperar.php" class="inst-link"><i class="fas fa-arrow-left"></i> Volver Atrás</a>
                </div>
            </div>
