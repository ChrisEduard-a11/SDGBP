...
<head>
    ...
    <title>Paso 3: Confirmar Código - SDGBP</title>
        ...
        <div class="login-form-container">
            <main>
                <div class="form-content animate__animated animate__fadeIn">
                    ...
                    <div class="text-center mb-4">
                        <h4 class="fw-bold">Paso 3: Seguridad 2FA</h4>
                        <p class="text-muted small">Ingresa el código enviado para finalizar.</p>
                    </div>

                    <div class="form-container">
                        <form action="../acciones/finalizar_recu_usuario.php" method="POST">
                            <div class="mb-3">
                            ...
                            <div class="text-center mt-4 mb-4">
                                <button class="boton w-100 py-3" type="submit">Finalizar Recuperación</button>
                            </div>

                            <div class="text-center mt-4">
                                <a class="btn btn-secondary btn-sm" href='verificar_email_usuario.php'>
