<?php
session_start();
if (empty($_SESSION['temp_recu_cedula']) || empty($_SESSION['temp_recu_correo_real'])) { header("Location: recuperar_usuario.php"); exit(); }
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Paso 3: Confirmar Código 2FA - SDGBP</title>
    ...
    <div class="login-layout">
        <div class="login-image-side">
            ...
            <div class="login-image-content">
                ...
                <p class="login-image-desc">Validaremos el código de 6 dígitos que fue enviado de manera cifrada a tu bandeja de correo personal para verificar tu autorización corporativa y devolverte tu cuenta.</p>
        ...
        <div class="login-form-side">
            <div class="login-form-container">
                ...
                <div class="stepper">
                    ...
                    <div class="step-item completed">
                        <div class="step-circle"><i class="fas fa-check"></i></div><div class="step-label">Correo</div>
                    </div>
                ...
                <div class="text-center md:text-left mb-6">
                    <h4 class="font-bold text-lg text-slate-800">Paso 3: Código Seguro</h4>
                    <p class="text-slate-500 text-sm font-medium mt-1">Ingresa el código cifrado para revelar tu usuario.</p>
                </div>

                <div class="alert-info-premium">
                    <i class="fas fa-paper-plane"></i>
                    <span>Hemos enviado un <b>código de 6 dígitos</b> a tu correo electrónico para que confirmes tu solicitud.</span>
                </div>

                <form action="../acciones/finalizar_recu_usuario.php" method="POST" onsubmit="return validateFormCodigo()" class="mt-4">
                    ...
                    <button class="inst-btn-submit" type="submit">
                        Finalizar Recuperación <i class="fas fa-user-check"></i>
                    </button>
                </form>
                ...
                <div class="inst-links">
                    <a href="verificar_email_usuario.php" class="inst-link"><i class="fas fa-arrow-left"></i> Cambiar correo</a>
                </div>
            </div>
