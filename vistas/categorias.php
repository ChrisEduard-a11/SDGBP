...
<div id="layoutSidenav_content">
    <div class="container-fluid px-4 py-4">
        ...
        <header class="page-header-standard d-flex justify-content-between align-items-center mb-4 animate__animated animate__fadeIn">
            <div>
                <h1 class="fw-bold mb-0 text-primary"><i class="fas fa-tags me-2"></i>Categorías de Bienes</h1>
                <p class="text-muted">Gestión y clasificación de bienes nacionales y suministros del sistema</p>
            </div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent p-0 m-0">
                    ...
                    <li class="breadcrumb-item active">Categorías de Bienes</li>
                </ol>
            </nav>
        </header>
