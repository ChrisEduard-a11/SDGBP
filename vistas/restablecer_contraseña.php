    ...
    <div class="login-layout">
        <div class="login-image-side">
            ...
            <div class="login-image-content">
                ...
                <p class="login-image-desc">Establece una contraseña fuerte y segura para proteger el acceso a tu plataforma administrativa. Has llegado aquí a través de un enlace cifrado seguro.</p>
        ...
        <div class="login-form-side">
            <div class="login-form-container">
                ...
                <div class="text-center md:text-left mb-6">
                    ...
                    <p class="text-slate-500 text-sm font-medium mt-1">Establece tu nueva clave de acceso segura a través del email.</p>
                </div>

                <form action="../acciones/restablecer_contraseña.php" method="POST" onsubmit="return validateFormRC()" class="mt-4">
                    ...
                    <div class="inst-input-wrapper">
                        ...
                        <input type="password" id="inputPassword" name="nueva_contraseña" class="inst-input" placeholder="Nueva Contraseña" autocomplete="off" />
                    ...
                    <div class="inst-input-wrapper">
                        <i class="fas fa-lock inst-icon"></i>
                        <input type="password" id="inputPasswordConfirm" name="confirmar_contraseña" class="inst-input" placeholder="Confirmar Contraseña" autocomplete="off" />
