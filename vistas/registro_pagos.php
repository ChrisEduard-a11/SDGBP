...
<div id="layoutSidenav_content">
    <div class="container-fluid px-4 py-4">
        ...
        <header class="page-header-standard d-flex justify-content-between align-items-center mb-4 animate__animated animate__fadeIn">
            <div>
                <h1 class="fw-bold mb-0 text-primary"><i class="fas fa-cash-register me-2"></i>Registrar Ingreso</h1>
                <p class="text-muted">Reporta tus pagos recibidos para su verificación y acreditación</p>
            </div>
